...
public class WineVariantRepository : IWineVariantRepository
{
    ...
    {
        return await _context.WineVariants.Include(wineVariant => wineVariant.Wine).ToListAsync();
    }
    ...
    public async Task<IEnumerable<WineVariant>> GetWineVariantsById(int id)
    {
        return await _context.WineVariants.Where(wineVariant => wineVariant.WineId == id).Include(wineVariant => wineVariant.Wine).ToListAsync();
    }
